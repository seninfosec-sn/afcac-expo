    ...
    <section className="register-cta" id="register">
      ...
      <div className="container cta-content">
        ...
        <div className="cta-actions">
          ...
          <a href="https://meet.afcac.org/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-white"><i className="fas fa-calendar-check" style={{ marginRight: '7px' }} />{r.meetingBtn}</a>
        </div>
      </div>
    </section>
  )
